...
Since we are running this on a personal laptop, lets use a low number cores and create a SOCK cluster. Now that I have prepared the variables, I can call the *setupParallel* function and build the directory structure. 
